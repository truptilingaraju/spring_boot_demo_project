package com.ty.springbootdemoproject.configuration;
...
public class ApplicationConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		contact.setEmail("info@employeeapp.in");
		contact.setName("EmployeeApp");
		...
		Info info = new Info().title("employeeApp RESTful Web Service documentation").version("1.0").contact(contact)
				.description("This API exposes endpoints to manage EmployeeApp.")
				.termsOfService("https://employeeapp.in/terms").license(mitLicense);
